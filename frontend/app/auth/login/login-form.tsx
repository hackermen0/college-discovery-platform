        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <form onSubmit={handleCredentialsLogin} className="space-y-4 mb-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-2 px-4 cursor-pointer bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 disabled:bg-gray-400 transition-colors"
            >
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full py-2 px-4 cursor-pointer border border-gray-300 rounded-lg font-medium text-gray-700 hover:bg-gray-50 disabled:bg-gray-100 transition-colors flex items-center justify-center gap-2"
          >
